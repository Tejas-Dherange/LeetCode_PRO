...
function HomePage() {
  return (
    <>
      ...
      <div className="min-h-screen w-full   flex  flex-col items-center justify-center relative overflow-x-hidden animate-fade-in">
        {/* Hero Section */}
        ...
        <header className="relative w-full bg-gradient-to-br from-slate-900 via-black to-indigo-900 min-h-[65vh] flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="space-y-8 mb-8 max-w-4xl mx-auto">
              <p className="text-lg md:text-xl text-gray-200 font-medium leading-relaxed">
                Hi, I'm{" "}
                <span className="text-blue-400 font-semibold">Tejas</span> — a
          ...
          <div className=" mt-10 rounded-xl overflow-hidden py-2 px-4 md:px-8">
            <img
              src="/dashboard.png"
              alt="Dashboard UI preview"
              loading="lazy"
              className="w-full h-auto max-w-[100%] md:max-w-[90vw] lg:max-w-[69vw] mx-auto rounded-xl object-contain transition-all duration-500 hover:ring-2 hover:ring-purple-800 transform  ease-in-out hover:scale-102 hover:ring-offset-1 hover:ring-offset-black cursor-pointer"
            />
          </div>
        ...
        <section className=" mx-auto py-14 px-24 relative w-full bg-gradient-to-br from-indigo-900 via-black to-slate-900 min-h-[65vh] flex flex-col items-center justify-center text-center  overflow-hidden ">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-10">
            <div className="bg-base-100 w-[90vw] md:w-full p-8 rounded-2xl shadow-xl text-center border border-primary/10">
            ...
            <div className="bg-base-100 p-8 w-[90vw] md:w-full rounded-2xl shadow-xl text-center border border-success/10">
            ...
            <div className="bg-base-100 p-8 w-[90vw] md:w-full rounded-2xl shadow-xl text-center border border-blue-500/10">
          ...
          <div className="mt-16 text-center w-[90vw] md:w-full md:max-w-2xl md:mx-auto bg-base-100/80 rounded-2xl shadow-lg p-8 border border-primary/10">
