    ...
    <div className="min-h-screen w-[100vw]  ">
      ...
      <div className="text-center mb-16 px-6">
        ...
        <p className="text-2xl text-base-content/80 max-w-3xl mx-auto leading-relaxed">
          Level up your coding journey with the right plan. Choose the perfect subscription to unlock your potential.
        </p>
        ...
        {plans.map((plan, idx) => (
          ...
          >
            ...
            <div className="card-body p-8 items-center text-center">
              {/* Plan Header */}
              <div className={`w-20 h-20 rounded-full bg-gradient-to-r ${plan.gradient} flex items-center justify-center mb-6`}>
                <span className="text-2xl font-bold text-white">{plan.name[0]}</span>
              </div>
              
              <h2 className="card-title text-3xl font-bold mb-2">{plan.name}</h2>
              
              {/* Pricing */}
              <div className="mb-6">
                <p className="text-5xl font-extrabold text-primary">{plan.price}</p>
                <p className="text-lg text-base-content/60 mt-1">{plan.period}</p>
              </div>
              ...
              <ul className="w-full text-left space-y-4 mb-8">
                {plan.features.map((feature, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="text-success text-xl flex-shrink-0 mt-0.5">✓</span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-base-content/70">Accelerate your coding skills with our structured approach</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-3">💼</div>
              <h4 className="font-semibold mb-2">Career Ready</h4>
              <p className="text-base-content/70">Get interview-ready with real company problems</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-3">🏆</div>
              <h4 className="font-semibold mb-2">Proven Results</h4>
              <p className="text-base-content/70">Join thousands of successful developers</p>
            </div>
          </div>
        </div>
      </div>
