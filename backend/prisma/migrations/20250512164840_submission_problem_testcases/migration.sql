...
CREATE TABLE "TeastCaseResult" (
    ...
    CONSTRAINT "TeastCaseResult_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "TeastCaseResult_submissionId_idx" ON "TeastCaseResult"("submissionId");
...
-- AddForeignKey
ALTER TABLE "TeastCaseResult" ADD CONSTRAINT "TeastCaseResult_submissionId_fkey" FOREIGN KEY ("submissionId") REFERENCES "Submission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
